        ...
        <>
            <div className="upwards-load">
                <div className="mt-[85px]">
                    <div className="text-primary font-bold text-center w-full font-dm-sans leading-[0.85] text-[15.8vw]">About Me</div>
                </div>
            </div>
            <div className="zoom-load">
                <div className="mt-5 flex flex-col items-center gap-5 min-[873px]:flex-row min-[873px]:items-start">
                    <WelcomeCard>
                    ...
                    <SquareCard style={{ padding: '20px' }} onClick={() => {console.log('Card clicked!');}} disableHover>
                        <h1 className="mb-4">Hey👋<br/>I'm Rohan</h1>
                ...
                <div className="mt-5 flex flex-col items-center gap-5 min-[873px]:flex-row min-[873px]:items-start">
                    <RectangleCard style={{ padding: '20px' }} onClick={() => {console.log('Card clicked!');}} disableHover>
                        <h1 className="mb-4">Full Stack</h1>
                    ...
                    <RectangleCard style={{ padding: '20px' }} onClick={() => {console.log('Card clicked!');}} disableHover>
                        <h1 className="mb-4">Additional</h1>
